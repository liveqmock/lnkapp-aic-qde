...
public class FormatTest {
    ...
    public static void main(String... argv) throws Exception {
        ...
        SeperatedTextDataFormat dataFormat = new SeperatedTextDataFormat("org.fbi.linking.codec.dataformat.samples.staringmodel.T1000");
        ...
        FixedLengthTextDataFormat dataFormat1 = new FixedLengthTextDataFormat("org.fbi.linking.codec.dataformat.samples.aicmodel.T2000");
        TIA2000 tia2000 = (TIA2000)dataFormat1.fromMessage(tiaStr.getBytes("GBK"), "TIA2000");
